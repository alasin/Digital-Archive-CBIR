...
<dt>
    <h4 class="name" id="Session"><span class="type-signature"></span>new Session<span class="signature">(host, port, username, password)</span><span class="type-signature"></span></h4>
