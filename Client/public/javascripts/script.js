function locationSearch() {
    ...
    $.ajax({
            ...
            url: "/search",
            data: {
                searchQuery: document.getElementById("locationSearchBox").value,
                searchType: "location"
            }
        })
        .done(function(data) {
...
function objectSearch() {
    ...
    $.ajax({
            ...
            url: "/search",
            data: {
                searchQuery: document.getElementById("objectSearchBox").value,
                searchType: "object"
            }
        })
        .done(function(data) {
...
function themeSearch() {
    ...
    $.ajax({
            ...
            url: "/search",
            data: {
                searchQuery: document.getElementById("themeSearchBox").value,
                searchType: "theme"
            }
        })
        .done(function(data) {
...
function styleSearch() {
    ...
    $.ajax({
            ...
            url: "/search",
            data: {
                searchQuery: document.getElementById("styleSearchBox").value,
                searchType: "style"
            }
        })
        .done(function(data) {
